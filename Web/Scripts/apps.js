var handleHomeContentHeight = function() { $("#home").height($(window).height()) };
...
var handleAddCommasToNumber = function(e) { return e.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") };
var handlePageContainerShow = function() { $("#page-container").addClass("in") };
var handlePaceLoadingPlugins = function() { Pace.on("hide", function() { $(".pace").addClass("hide") }) };
            ...
            $(e).find("[data-animation=true]").each(function() {
                ...
                if (!$(t).hasClass("contentAnimated")) {
                    if (e == "number") {
                        ...
                        $({ animateNumber: 0 }).animate({ animateNumber: n }, {
